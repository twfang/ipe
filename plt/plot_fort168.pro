pro plot_fort168
factor_window=0.8
RUN_DIR='/home/Naomi.Maruyama/idea/20120217.3d.trans.v43/'
mlat_title='16'
plot_UT =16.97;40.97 ;16.97 ;52.97 ;64.97 ;17.06;
;high resolution
...
filename='mlat'+mlat_title+'_UT'+STRTRIM( string(ut_hr, FORMAT='(f7.2)'), 1)+'.png'
output_png, filename
BREAK
