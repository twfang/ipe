...
if ( sw_dot eq 1 ) then begin
   ...
   if (ut_hr-ut0) eq  2. then  line_style=0  else $ ;nm20141008 new MIN
   if (ut_hr-ut0) eq  6. then  line_style=4  else $
   if (ut_hr-ut0) eq 10. then line_style=2  else $ 
   if (ut_hr-ut0) eq 14. then line_style=4  else $
   if (ut_hr-ut0) eq 18. then line_style=0  else $
   ;if (ut_hr-ut0) eq 20. then line_style=5  else $
   if (ut_hr-ut0) eq 22. then line_style=3       $
   else begin
...
print, 'rd_wind_v2 finished successfully'
end
