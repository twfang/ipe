...
if ( sw_dot eq 1 ) then begin
   ...
   ;if (ut_hr-ut0) eq  0. then  line_style=0  else $ ;nm20141008 new MIN
   if (ut_hr-ut0) eq  4. then  line_style=4  else $
   if (ut_hr-ut0) eq 9. then line_style=2  else $ 
   if (ut_hr-ut0) eq 14. then line_style=5  else $
   if (ut_hr-ut0) eq 19. then line_style=3  else $
