...
;'378';windX1.5 jid79
; '22905';ori jid72
;'1452517624' ;jid201601103
;'1452823230' ;jid20160112 v3
;'1452823527' ;v4
;'1452823652' ;v5
;'1452823698' ;v6
;'1453555731' ;jid20160112 v20
;'1453556049' ;jid20160112 v21
;'1453558480' ;jid20160112 v22
;'1453558551' ;jid20160112 v23
;'1452876517' ;jid20160112 v7 16.5ut
'1452876646' ;jid20160112 v8 16ut
;'1452862845' ;jid20160112 v9 15.5
;'1452862913' ;jid20160112 v10 15ut
;'1452823230' ;ori
...
;493200. -3600.
;493200.
plot_UT_end=493200.;plot_UT;[sec]

alt=350.

HOME_DIR='/scratch3/NCEPDEV/swpc/noscrub/Naomi.Maruyama/'
...
if ( sw_read_wind eq 1 ) then begin
   luntmp7=101
   luntmp3=102
   dirtmp7=HOME_DIR+TEST+'/trunk/run/ipe_'+TEST2+'_'+TEST1+'/' ;output from IPE
;input to IPE
...
if ( TEST eq 'r319' ) then $
  rundir='ipe_'+TEST2+'_'+TEST1 $
else $
;latest paul's runDIR
  rundir= $
;TEST1+'_ipe_theia_intel_parallel_'+TEST2
TEST1+'_ipe_theia_intel_parallel1_'+TEST2

input_DIR0=HOME_DIR+'ipe/runs/'+TEST+'/trunk/run/'+rundir+'/'
...
;'ipe4gsd/run_naomi/'
;TEST+'/bkup19/'
input_DIR[1]=HOME_DIR+'ipe/grid/plt/'
LUN  = INTARR(n_file)
...
;     ctr_lat_ht_tecut137cmp    $  ;tmp20160125
  , JMIN_IN,JMAX_IS,Z_km,mlat_deg  $ 
