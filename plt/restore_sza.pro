...
sw_debug=0L
rundir=$
'1481629509_ipe_theia_intel_parallel2_80';v32 depeleted lp<23
...
print,'i2',x[i2], MAX(z[i2,*]), MIN(z[i2,*])
X0=X0+dX
X1=X0+dX
;2)sza=125
plot, z[i2,*],yz $
...
, 'MAX: '+STRTRIM( string(MAX(z),  FORMAT=format) ,1)+' ['+titleUni+']' $
...
filename_image=plot_DIR1+'sza'+titlePar+titleHem+'Total.png' 
