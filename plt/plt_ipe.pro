...
if ( sw_output2file_ascii eq 1 ) then begin
   ...
   chr_title1=STRTRIM( string(alt, FORMAT='(i3)'), 1)+'km'
   flnmtmp='/scratch1/portfolios/NCEPDEV/swpc/noscrub/Naomi.Maruyama/hinotori/hinotori_te'+chr_title1+'.'+chr_title+'.dat'
   luntmp=100
   openw,luntmp,flnmtmp, /GET_LUN
   print, 'hinotori file created:',flnmtmp
endif ;( sw_output2file_ascii eq 1 ) then begin
fac_window=1.0
