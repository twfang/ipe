...
print, max(plot_xx), min(plot_xx)
X_max=95.;421106./3600.;71. ;47.;68.9739-5.; MAX(plot_xx); 24.0
...
WINDOW,iwindow,XSIZE=500*2,YSIZE=500 ;20120406 validation
!P.MULTI=[0,2,1] ;20120406 validation
loadct,n_ldct
