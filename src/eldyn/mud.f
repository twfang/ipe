...
!     Coefficients cee(ncee) are passed thru ceee_com common block in 
!     ceee.h  subroutine dismd2cr and adjmd2cr are modified
!     all references to coef and bndyc are removed
!     the common subroutine file "mudcom.f" is attached to the end
!
! 5/02 B. Foster:
...
!c
!     see the documentation file "mud2cr.d" for a complete discussion
!     of how to use subroutine mud2cr.  file "tmud2cr.f" is a test/driver
!     sample program illustrating use of mud2cr
!c
