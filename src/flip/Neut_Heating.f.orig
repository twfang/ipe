!20110812: temporarily commented out some modification because they were for 3D version!!!
C............................... NEUT_HEATING.FOR ...................................
...
!dbg20110404: output each component of heating rate
!t      USE module_FIELD_LINE_GRID_MKS,ONLY:JMIN_IN
!t      USE module_heating_rate,ONLY:mp_save,lp_save,hrate_save_cgs
      IMPLICIT NONE
...
!dbg20110404: output each component of the heating rate
!t      INTEGER :: j2d  !J converted to the 2Dsystem in a meridional plain.
...
!dbg20110404: output each component of heating rate
!t      j2d=ij+jmin_in(mp_save,lp_save)-1
!t      hrate_save_cgs(1,j2d,mp_save)=hrate(1) !!PGR neu_neu
!t      hrate_save_cgs(2,j2d,mp_save)=hrate(2) !!PGR O1D
!t      hrate_save_cgs(3,j2d,mp_save)=hrate(3) !!PGR ion_neu
!t      hrate_save_cgs(4,j2d,mp_save)=hrate(4) !!PGR elec_ion
!t      hrate_save_cgs(5,j2d,mp_save)=hrate(5) !!PGR SRO2dis
!t      hrate_save_cgs(6,j2d,mp_save)=hrate(6) !!PGR UVN2dis
!t      hrate_save_cgs(6,j2d,mp_save)=hrate(7) !!PGR 3bod CHECK dimension
