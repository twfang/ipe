...
!--------------------------------------------  
      MODULE module_sub_FIELD_LINE_GRID_MKS
      USE module_precision
      USE module_IPE_dimension,ONLY: NMP,NLP,ISTOT
      IMPLICIT NONE
!
!nm20121003:module parameters are separated into module_field_line_grid.f90
!
...
!---------------------------
      END MODULE module_sub_FIELD_LINE_GRID_MKS
